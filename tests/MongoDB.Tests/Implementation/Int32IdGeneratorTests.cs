...
{
    public class Int32IdGeneratorTests : InfrastructureTestsBase
    {
        private readonly IMongoDbContext _context;

        public Int32IdGeneratorTests(InfrastructureFixture infrastructureFixture)
        ...
        public void WhenSaving1ItemIncrementItsId()
        {
            ...
            var item = new StubInt32IdEntity { Name = "Testing 1" };

            var collection = _context.GetCollection<StubInt32IdEntity>("Int32IdEntities");
        ...
        public void WhenSaving2ItemsIncrementTheirIds()
        {
            ...
            var item1 = new StubInt32IdEntity { Name = "Testing 1" };
            var item2 = new StubInt32IdEntity { Name = "Testing 2" };
        ...
        public void WhenSavingABatchOfItemsIncrementTheirIds()
        {
            ...
            var items = new List<StubInt32IdEntity>();

            for (int i = 0; i < 1000; i++)
            {
                items.Add(new StubInt32IdEntity { Name = $"Testing {i}" });
            }
