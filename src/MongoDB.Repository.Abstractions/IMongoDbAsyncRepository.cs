...
{
    public interface IMongoDbAsyncRepository : IMongoDbRepository, IDisposable
    { }

    public interface IAsyncMongoDbRepository<T> : IMongoDbAsyncRepository, IMongoDbQueryFactory<T>, IDisposable where T : class
    {
